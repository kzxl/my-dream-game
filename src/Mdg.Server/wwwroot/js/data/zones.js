...
export const ZONES = {
  ...
  StormpeakRidge: {
    ...
    themeColor: '#67e8f9',
    icon: '👑',
    recommendedRes: 'Cold Res 60%',
    hazards: ['Cryo Vortexes', 'Glacial Shatter Bombs'],
    boss: '❄️ Cryomancer Vael the Frost Sovereign',
    coords: { x: 80, y: 30 },
    portals: [
      { x: 500, y: 2000, targetZone: 'FrostpeakTundra', targetX: 3300, targetY: 2000, name: '🌀 Descend Glacier' },
  ...
  NecropolisOfSouls: {
    ...
    themeColor: '#c084fc',
    icon: '👑',
    recommendedRes: 'Chaos Res 60% + All Elemental 50%',
