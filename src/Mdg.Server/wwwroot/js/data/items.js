...
export const SKILL_GEMS_DATABASE = [
  ...
  },
  {
    ...
    name: 'Vulnerability Curse Gem',
    baseType: 'Curse Skill Gem',
    category: 'gem',
    gemType: 'curse',
    slot: 'Gem',
    rarity: 'CurseGem',
    ...
    minIlvl: 12,
    requiredLevel: 10,
    description: 'Curses enemies: +35% Physical & Bleed damage taken, -25% Armor.',
    tags: ['curse', 'physical', 'hex'],
    curseType: 'vulnerability'
  },
  {
    id: 'curse_flammability',
    name: 'Flammability Curse Gem',
    baseType: 'Curse Skill Gem',
    category: 'gem',
    gemType: 'curse',
    slot: 'Gem',
    ...
    minIlvl: 12,
    requiredLevel: 10,
    description: 'Curses enemies: -35% Fire Resistance, +30% Ignite Chance.',
    tags: ['curse', 'fire', 'hex'],
    curseType: 'flammability'
  },
  {
    id: 'curse_frostbite',
    name: 'Frostbite Curse Gem',
    baseType: 'Curse Skill Gem',
    category: 'gem',
    gemType: 'curse',
    slot: 'Gem',
    ...
    minIlvl: 12,
    requiredLevel: 10,
    description: 'Curses enemies: -35% Cold Resistance, -35% Movement & Attack Speed.',
    tags: ['curse', 'cold', 'hex'],
    curseType: 'frostbite'
  },
  {
    id: 'curse_conductivity',
    name: 'Conductivity Curse Gem',
    baseType: 'Curse Skill Gem',
    category: 'gem',
    gemType: 'curse',
    slot: 'Gem',
    ...
    minIlvl: 12,
    requiredLevel: 10,
    description: 'Curses enemies: -35% Lightning Resistance, +50% Shock Damage taken.',
    tags: ['curse', 'lightning', 'hex'],
    curseType: 'conductivity'
  },
  {
    id: 'curse_enfeeble',
    name: 'Enfeeble Curse Gem',
    baseType: 'Curse Skill Gem',
    category: 'gem',
    gemType: 'curse',
    slot: 'Gem',
    ...
    minIlvl: 12,
    requiredLevel: 10,
    description: 'Curses enemies: -30% Damage Dealt, -30% Monster Crit Chance.',
    tags: ['curse', 'chaos', 'hex'],
    curseType: 'enfeeble'
  },
  {
    id: 'support_blasphemy_aura',
    name: 'Blasphemy Aura Support Gem',
    baseType: 'Support Gem',
    category: 'gem',
    gemType: 'support',
    slot: 'Gem',
    ...
    minIlvl: 24,
    requiredLevel: 20,
    description: 'Converts linked Curse into a 220px persistent aura debuffing surrounding enemies. Reserves 25% Mana.',
    tags: ['support', 'aura', 'curse'],
    isBlasphemy: true
  }
];
