...
namespace Mdg.Server.Services
{
    public sealed class ProfessionService
    {
        private static readonly Dictionary<string, ResourceNodeDefinition> NodeCatalog = new()
        {
            ...
            ["node_pure_silver"] = new("node_pure_silver", "mining", 15, "mat_pure_silver", 2, 4, 60),
            ["node_titan_ore"] = new("node_titan_ore", "mining", 25, "mat_titan_ore", 2, 3, 80),
            ["node_adamantite"] = new("node_adamantite", "mining", 35, "mat_adamantite_ingot", 1, 2, 120),
            ["node_aether_crystal"] = new("node_aether_crystal", "mining", 40, "mat_aether_crystal", 2, 3, 140),
            ["node_astral_crystal"] = new("node_astral_crystal", "mining", 45, "mat_astral_crystal", 1, 2, 180),

            // Herbalism
            ["node_aether_water"] = new("node_aether_water", "herbalism", 1, "mat_aether_water", 2, 5, 20),
            ["node_blood_herb"] = new("node_blood_herb", "herbalism", 1, "mat_blood_herb", 3, 5, 20),
            ["node_mana_bloom"] = new("node_mana_bloom", "herbalism", 10, "mat_mana_bloom", 3, 5, 40),
            ["node_moon_spore"] = new("node_moon_spore", "herbalism", 15, "mat_moon_spore", 2, 4, 55),
            ["node_wind_leaf"] = new("node_wind_leaf", "herbalism", 25, "mat_wind_leaf", 2, 4, 75),
            ["node_heartwood"] = new("node_heartwood", "herbalism", 20, "mat_heartwood", 1, 3, 60),
            ["node_dragon_lily"] = new("node_dragon_lily", "herbalism", 35, "mat_dragon_lily", 2, 4, 110),
            ["node_starflower"] = new("node_starflower", "herbalism", 45, "mat_starflower", 1, 2, 160),
